...
PRE_CLEAR_PROMPT = (
    ...
    "pending IRC requests, messages-to-relay, partial work, "
    "new standing orders, lessons learned. "
    "Use memory/ for long-term, project_activity_log.md for ephemera. "
    "Do not reply on IRC unless mid-sentence. Write only."
)
